...
function App() {
  ...
  return (
    <div className='w-full h-screen flex flex-wrap justtify-center items-center bg-cover bg-no-repeat'
      style={{ backgroundImage: `url(https://images.pexels.com/photos/325154/pexels-photo-325154.jpeg?auto=compress&cs=tinysrgb&w=600)` }}
    >
